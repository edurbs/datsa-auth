...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        // .authorizedGrantTypes("password", "refresh_token") // password with refresh
        // token flow
        // .scopes(WRITE, READ)
        ...
        // .authorizedGrantTypes("authorization_code") // authorization code flow with
        // PKCE support
        // .scopes(WRITE, READ)
        // .redirectUris("http://localhost:8081") // in production must be https and use
        // real client URL
        // .and()
